...
public class TelaClientesCad extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel2);
        jLabel2.setBounds(20, 240, 86, 34);
        ...
        txtBuscaCliente.setFont(new java.awt.Font("Segoe UI", 0, 15)); // NOI18N
        txtBuscaCliente.setPreferredSize(new java.awt.Dimension(64, 30));
        jPanel1.add(txtBuscaCliente);
        txtBuscaCliente.setBounds(450, 240, 160, 30);
    ...
    private void TblClientesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TblClientesMouseClicked
        txtNome1.setText(TblClientes.getValueAt(TblClientes.getSelectedRow(), 1).toString());
        txtCpf.setText(TblClientes.getValueAt(TblClientes.getSelectedRow(), 2).toString());
        txtDataNasc.setText(TblClientes.getValueAt(TblClientes.getSelectedRow(), 3).toString());
    ...
    private void btnAtualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAtualizarActionPerformed
        try{
            ...
            ClientesDao funcDao = new ClientesDao();
            funcDao.atualizar(cli);
    ...
    private void botaoBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoBuscarActionPerformed
        String nomebuscado = txtBuscaCliente.getText().trim();
        try{
            ...
            ClientesDao cliDao = new ClientesDao();
            List<Clientes> clientesEncontrados = cliDao.buscaClientePorNome(nomebuscado);
            ...
            if(clientesEncontrados.isEmpty()){
                ...
                for(Clientes c: clientesEncontrados){
                    tableClientes.addRow(new Object[]{c.getId(), 
                        c.getNome(), 
                        c.getCpf(), 
                        c.getDataNascimento(), 
                        c.getTelefone()});
